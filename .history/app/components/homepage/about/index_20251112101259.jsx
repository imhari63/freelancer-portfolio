      ...
      <div className="relative z-10 container mx-auto px-6 md:px-12 flex flex-col md:flex-row items-center justify-between gap-16">
        ...
        >
          ...
          <p className="text-gray-300 leading-relaxed mb-6">
            I’m a freelance <b>graphic designer, video editor, and web developer</b> driven by a passion for blending creativity with technology. I love turning ideas into visuals, stories, and experiences that connect with people.{" "}
            <br>
            </br>Beyond design, I’m exploring the world of{" "}
            <span className="text-violet-400 font-semibold">
              Organoid Intelligence
            </span>
            , and preparing for{" "}
            <b>TNPSC Group Exams</b>. because I believe real innovation comes from balancing logic, art, and discipline.{" "}
          </p>

          <p className="text-gray-400 mb-6">
            Grounded in traditional values of hard work and craftsmanship, my vision is to create digital work that feels human, intelligent, and timeless.
          </p>

          <div className="mt-8">
            <p className="text-violet-400 font-bold text-xl">– Hariharan R</p>
            <p className="text-gray-400 text-sm">
              Engineering Student & Free;a
            </p>
          </div>
        </motion.div>
