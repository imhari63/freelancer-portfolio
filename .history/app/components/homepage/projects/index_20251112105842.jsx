// Minimal placeholder to fix build error"use client"

export default function ProjectsIndex() {

  return (import { useState, useMemo, useEffect } from 'react'

    <div style={{color: '#fff', padding: '2rem', textAlign: 'center'}}>import Image from 'next/image';

      <h2>Projects Section</h2>import Link from 'next/link';

      <p>This is a placeholder for the projects section. Add your content here.</p>import { FaExternalLinkAlt, FaCode, FaPlay, FaTimes, FaEye } from 'react-icons/fa';

    </div>import { projectsData } from '@/utils/data/projects-data';
