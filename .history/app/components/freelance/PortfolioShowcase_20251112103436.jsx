          ...
          <nav className="flex gap-2">
            {filters.map(f => (
              <button
                key={f}
                onClick={() => setFilter(f)}
                className={`px-3 py-1 rounded-full text-sm cursor-pointer focus-visible:ring-2 focus-visible:ring-violet-400 ${filter===f? 'bg-violet-600 text-white' : 'bg-white/5 text-gray-200'}`}
